function initengahan(){
  ...
  function tombol(){wallpaper.style="transform: scale(1);";Tombol.style="opacity:1;transform: scale(1);";if(fungsi==2){By.innerHTML="&#128140; Reply"}}
  ...
  function gantiopsL(){opsL.innerHTML="[ Tap beberapa LOVE-nya ]";opsL.style.opacity=".8";}
  ...
  function aktipesan4(){
    wallpaper.style="transform: scale(1.5);";
    kalimat.innerHTML=pesan4.innerHTML + nama + ""; /* bisa di tambah emot di "" */
  ...
  afterComplete: function(){
    pesan5.innerHTML=vketik5 + "";setTimeout(aktipesan6,800); /* bisa di tambah emot di "" */
  },}).go();
  }
